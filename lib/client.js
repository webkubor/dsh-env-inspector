	...
	factory: (require) => {
		...
		function ensureStyle() {
			...
			style.textContent = [
				...
				// 全屏 Tab 视图样式
				'.dsh-env-inspector__view-container{padding:24px 32px;max-width:860px;margin:0 auto;',
				'overflow-y:auto;height:100%;font-size:13px;line-height:20px}',
				'.dsh-env-inspector__view-head{display:flex;align-items:baseline;justify-content:space-between;',
				'margin-bottom:16px;border-bottom:.5px solid var(--dsw-alias-border-l1);padding-bottom:8px}',
				'.dsh-env-inspector__view-title{font-size:18px;font-weight:600;',
		...
		function EnvInspectorView(props) {
			...
			return h('div', { className: 'dsh-env-inspector__view-container' },
				h('div', { className: 'dsh-env-inspector__view-head' },
					h('h2', { className: 'dsh-env-inspector__view-title' }, t('title')),
